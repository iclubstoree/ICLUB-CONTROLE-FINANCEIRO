...
const EditLojas = () => {
  ...
  const { lojasId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: lojasId }))
  }, [lojasId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: lojasId, data }))
...
EditLojas.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
